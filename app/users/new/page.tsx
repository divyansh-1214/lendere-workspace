      ...
      <section className="auth-panel"><div className="auth-form-wrap">
        ...
        {loadingSession ? <p className="form-state">Checking your permissions...</p> : session ? <form className="auth-form" onSubmit={submit}>
          ...
          <div className="auth-form-grid">
            ...
            <label>Password<input type="password" value={form.password} onChange={(event) => update("password", event.target.value)} autoComplete="new-password" minLength={4} required /><small className="field-help">Use at least 4 characters.</small></label>
          </div>
